    ...
    <div className="flex flex-col h-screen w-screen overflow-hidden">
      ...
      <div className="relative z-10 p-6 flex flex-row items-center space-x-20"> {/* Adjusted spacing here */}
          <div className="max-w-2xl text-white">
            <h1 className="text-5xl mb-2 text-left leading-snug">
              Welcome to<br />
              BukSU Dental <br />
              Clinic!
            </h1>
          ...
          <div className="p-4 flex items-start justify-start text-left">
            <p className="text-xl">
              We <br />
              Provide<br />
      ...
      <header className="header bg-gradient-to-b from-gray-600 to-gray-700 text-white text-center p-1">
        <h1 className="header-title text-lg font-normal mb-2">Stay Connected With BukSU Clinic</h1>
      </header>
